...
function SentimentRiskDashboard() {
  ...
  const score = Math.max(
    24,
    company.score - (period === "7일" ? 4 : period === "3개월" ? 7 : 0),
  );
            ...
            {companies.map((item, index) => (
              ...
              >
                ...
                <span>
                  ...
                  <small>{item.ticker} · KOSPI</small>
                </span>
                <i className={item.delta < 0 ? "down" : ""}>
                  {item.delta > 0 ? "+" : ""}
                  {item.delta}%
                </i>
              </button>
        ...
        <main className="sr-main" id="analysis">
          ...
          <section className="sr-company-bar">
            ...
            <div>
              ...
              <span>{company.ticker} · KOSPI</span>
            </div>
          ...
          <section className="sr-metric-grid" aria-label="핵심 지표">
              ...
              <div className="sr-score-content">
                ...
                <div className="sr-score-copy">
                  ...
                  <p>
                    ...
                    <br />
                    <strong>
                      +{company.delta > 0 ? company.delta : 2.4}%
                    </strong>{" "}
                    상승
                  </p>
                </div>
            ...
            <article className="sr-card sr-sentiment-card">
              <div className="sr-card-head">
                <span>감성 분포</span>
                <small>총 2,616건</small>
              </div>
              <div
                className="sr-donut"
                aria-label="부정 54%, 중립 29%, 긍정 17%"
              >
                <div>
                  <strong>54%</strong>
                  <span>부정</span>
            ...
            <article className="sr-card sr-keyword-card">
              ...
              <div className="sr-keywords">
                <span className="xl">공급망</span>
                <span className="lg">규제</span>
                <span className="md">실적 우려</span>
                <span className="sm">수율</span>
                <span className="lg">불확실성</span>
                <span className="sm">경쟁 심화</span>
                <span className="md">가격 하락</span>
                <span className="sm">투자 감소</span>
              </div>
            </article>
          </section>
            ...
            <div className="sr-summary-body">
              <div className="sr-summary-copy">
                ...
                <p>
                  ...
                  비중은 54%로 나타났습니다. 특히 공급망 차질과 규제 강화
                  가능성을 다룬 보도가 빠르게 확산되며 전체 위험도를 끌어올리고
                  있습니다.
                </p>
              </div>
